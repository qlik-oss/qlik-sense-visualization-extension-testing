# Contributing to qlik-sense-visualization-extension-testing

You are more than welcome to contribute to qlik-sense-visualization-extension-testing Follow these guidelines and you will be ready to start:
...
```sh
git clone git@github.com:YOUR-USERNAME/qlik-sense-visualization-extension-testing.git
```
